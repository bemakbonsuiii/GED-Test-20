...
const DebtPayoff = () => {
  ...
  const weightedAPR =
    debts.reduce((sum, debt) => sum + debt.apr * debt.balance, 0) / totalDebt;
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="border-l-4 border-l-financial-danger">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">Across 4 accounts</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-financial-warning">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{weightedAPR.toFixed(1)}%</div>
            <p className="text-xs text-slate-500 mt-1">Average interest rate</p>
          </CardContent>
        </Card>
              ...
              <Tabs value={strategy} onValueChange={setStrategy}>
                ...
                <TabsContent value="avalanche" className="space-y-4 mt-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    ...
                    <p className="text-sm text-blue-800 dark:text-blue-200">
                      Pay minimums on all debts, then put extra money toward the
                      debt with the highest interest rate. This saves the most
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-financial-success">
                        {Math.round((avalanche.totalMonths / 12) * 10) / 10}{" "}
                        years
                      </p>
                ...
                <TabsContent value="snowball" className="space-y-4 mt-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-financial-success">
                        {Math.round((snowball.totalMonths / 12) * 10) / 10}{" "}
                        years
                      </p>
                      <p className="text-sm text-slate-500">Payoff time</p>
                    </div>
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 border rounded-lg ${
                        isFirst
                          ? "border-financial-success bg-financial-success/5"
                    ...
                    >
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            ${Math.round(debt.interest).toLocaleString()}
                          </p>
                        </div>
                      </div>
                      ...
                      {isFirst && (
                        <div className="mt-3 p-2 bg-financial-success/10 border border-financial-success/20 rounded text-sm">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-financial-success font-medium">
                              Focus here first
                            </span>
                          </div>
                        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-center p-3 bg-financial-success/10 border border-financial-success/20 rounded-lg">
                ...
                <p className="text-2xl font-bold text-financial-success">
                  {Math.round((currentStrategy.totalMonths / 12) * 10) / 10}{" "}
                  years
                </p>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span>
                    {Math.round(
                      ((totalMinPayments + extraPayment) / 4700) * 100,
                    )}
                    %
                  </span>
                </div>
                <Progress
                  value={((totalMinPayments + extraPayment) / 4700) * 100}
                  className="h-2"
                />
              </div>
            </CardContent>
              ...
              <div className="p-3 border rounded-lg">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      All 3 cards paid off
                    </p>
                  </div>
                  <Badge variant="outline">
                    {Math.max(
                      ...currentStrategy.payoffOrder
                        .slice(0, 3)
                        .map((d) => d.months),
                    )}
                    mo
